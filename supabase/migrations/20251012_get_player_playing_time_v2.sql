-- Add versioned RPC for player time calculation to avoid signature conflicts
-- New function: public.get_player_playing_time_v2()

begin;

create or replace function public.get_player_playing_time_v2()
returns table (
  player_id uuid,
  first_name text,
  last_name text,
