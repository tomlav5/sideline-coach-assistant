-- Performance Optimization for Reports System - Simplified
...
SELECT DISTINCT
    CASE 
        WHEN competition_type IS NOT NULL THEN 'type:' || competition_type
        ELSE competition_name
    END as filter_value,
    CASE 
        WHEN competition_type IS NOT NULL THEN competition_type
        ELSE competition_name
    END as display_name,
    competition_type,
    competition_name
